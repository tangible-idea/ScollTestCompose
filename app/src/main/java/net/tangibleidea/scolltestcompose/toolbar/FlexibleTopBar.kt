package com.afsshlife.ui.activity.compose.widget.toolbar
    ...
    Surface(modifier = modifier.then(appBarDragModifier), color = appBarContainerColor) {
        Layout(
            ...
            measurePolicy = { measurables, constraints ->
                ...
                val layoutHeight = maxOf(height.roundToInt(), 0) // 음수 방지
                layout(constraints.maxWidth, layoutHeight) {
                    placeable.place(0, scrollOffset.toInt().coerceAtLeast(0)) // 음수 방지
                }
            }
        )
    }
